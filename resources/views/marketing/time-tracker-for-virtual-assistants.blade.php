...
>
    ...
    <section class="overflow-hidden bg-[var(--color-bg)] py-20 lg:py-28">
        <div class="mx-auto grid max-w-7xl grid-cols-1 items-center gap-16 px-6 lg:grid-cols-12 lg:px-8">
            <div class="lg:col-span-7">
                ...
                <h1 class="max-w-4xl text-4xl leading-[1.05] font-display text-[var(--color-text)] sm:text-6xl">
                    {{ __('Time tracking for virtual assistants with multiple direct clients') }}
                </h1>
                <p class="mt-6 max-w-2xl text-lg leading-relaxed text-[var(--color-text-secondary)] sm:mt-8 sm:text-xl">
                ...
                <div class="mt-6 rounded-2xl border-2 border-[var(--color-primary)] bg-[var(--color-surface)] p-4 sm:mt-8 sm:p-5">
                ...
                <p class="mt-3 text-sm text-[var(--color-text-muted)] sm:mt-4">{{ __('60-day trial. Then €59/year for the managed version.') }}</p>
            </div>
    ...
    <section id="features" class="bg-[var(--color-surface)] py-20 lg:py-24">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="max-w-2xl">
                ...
                <h2 class="mt-3 text-3xl font-display text-[var(--color-text)] sm:text-4xl">{{ __('The details that matter when client work comes in small pieces') }}</h2>
            </div>
    ...
    <section id="see-it" class="bg-[var(--color-bg)] py-20 lg:py-24">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="mx-auto max-w-3xl text-center">
                ...
                <h2 class="mt-3 text-3xl font-display text-[var(--color-text)] sm:text-4xl">{{ __('Start a timer, switch work, send the report') }}</h2>
    ...
    <section class="bg-[var(--color-bg)] py-20 lg:py-24">
        <div class="mx-auto grid max-w-6xl items-center gap-12 px-6 lg:grid-cols-2 lg:px-8">
            <div>
                <h2 class="text-3xl font-display text-[var(--color-text)] sm:text-4xl">{{ __('Your timer is a work log, not a monitoring system') }}</h2>
    ...
    <section id="pricing" class="bg-[var(--color-surface)] py-20 lg:py-24">
        <div class="mx-auto max-w-5xl px-6 lg:px-8">
            <div class="rounded-3xl border-2 border-[var(--color-primary)] bg-[var(--color-bg)] p-6 text-center sm:p-12">
    ...
    <section id="fit" class="bg-[var(--color-bg)] py-20 lg:py-24">
        <div class="mx-auto max-w-4xl px-6 lg:px-8">
            <h2 class="text-3xl font-display text-[var(--color-text)] sm:text-4xl">{{ __('A clear fit, and a clear boundary') }}</h2>
    ...
    <section class="bg-[var(--color-primary)] py-20">
        <div class="mx-auto max-w-3xl px-6 text-center lg:px-8">
            <h2 class="text-3xl font-display text-white sm:text-4xl">{{ __('Make your next client workday easier to account for') }}</h2>
