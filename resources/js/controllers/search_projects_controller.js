...
export default class extends Controller {
    ...
    createProjectFromFields(event) {
        ...
        if (!nameInput || !nameInput.value.trim()) {
            this.showFieldError(nameInput, "Please enter a project name");
            return;
        }

        if (!clientIdInput || !clientIdInput.value) {
            this.showFieldError(nameInput, "No client selected. Please select a client first.");
            return;
        }
        ...
        fetch(createUrl, {
            ...
            .catch((error) => {
                ...
                this.showFieldError(nameInput, "Error creating project. Please try again.");
            })
            .finally(() => {
                // Re-enable button
    ...
    displayValidationErrors(errors, nameInput, rateInput) {
        ...
        // Handle client_id errors
        if (errors.client_id) {
            this.showFieldError(nameInput, errors.client_id[0]);
        }
