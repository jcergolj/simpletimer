<x-layouts.app :title="__('Profile & Settings')">
    <div class="max-w-2xl mx-auto">
        ...
        <div class="bg-white rounded-lg border border-gray-200 divide-y divide-gray-200">
            ...
            <a href="{{ route('settings.database-backup.download') }}" class="flex items-center px-6 py-4 hover:bg-gray-50">
                <div class="flex-shrink-0">
                    <x-heroicon-o-arrow-down-tray class="h-6 w-6 text-blue-500" />
                </div>
                <div class="ml-4 flex-1">
                    <h3 class="text-sm font-medium text-gray-900">{{ __('Download Database Backup') }}</h3>
                    <p class="text-sm text-gray-500">{{ __('Download a copy of your database (.sqlite file)') }}</p>
                </div>
                <div class="flex-shrink-0">
