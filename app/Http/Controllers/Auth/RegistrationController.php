...
final class RegistrationController extends Controller
{
    public function __construct(
        private readonly TenantDatabaseService $tenantDb,
        private readonly SubdomainUrlBuilder $urlBuilder
    ) {}
    ...
    public function store(StoreRegistrationRequest $request)
    {
        ...
        $this->tenantDb->createTenantDatabase($subdomain);
        ...
        return redirect($this->urlBuilder->build($subdomain, '/dashboard'));
    }
}
