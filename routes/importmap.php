...
Importmap::pin('laravel-echo', to: '/js/vendor/laravel-echo.js'); // laravel-echo@2.5.0 downloaded from https://ga.jspm.io/npm:laravel-echo@2.5.0/dist/echo.js
Importmap::pin('pusher-js', to: '/js/vendor/pusher-js.js'); // pusher-js@8.6.0 downloaded from https://ga.jspm.io/npm:pusher-js@8.6.0/dist/web/pusher.js
