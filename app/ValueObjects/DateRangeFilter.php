...
class DateRangeFilter implements Arrayable, JsonSerializable
{
    ...
    {
        return new self(
            isset($data['start_date']) && $data['start_date'] ? Carbon::parse($data['start_date']) : null,
            isset($data['end_date']) && $data['end_date'] ? Carbon::parse($data['end_date']) : null
        );
    }
